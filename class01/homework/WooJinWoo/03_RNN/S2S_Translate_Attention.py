...
# padding : ¹®ÀåµéÀ» °°Àº ±æÀÌ·Î žÂÃã.
# truncation : ¹®ÀåÀÇ ±æÀÌžŠ ÇØŽç žðµšÀÇ ÃÖŽë ±æÀÌ·Î ÁŠÇÑÇÔ.
...
class DecoderAttention(nn.Module):
    ...
    def forward(self, encoder_outputs, encoder_hidden, target_tensor=None, teacher_forcing_ratio=0.5):
        ...
        # 출력 벡터의 차원 수 (in_featuree는 입력 벡터의 차원 수)
...
class Attention(nn.Module):
    def __init__(self, hidden_size):
        ...
        # decoder input으로 문자가 들어오니까 hidden size (wordvec)를 알고 있어야 함
