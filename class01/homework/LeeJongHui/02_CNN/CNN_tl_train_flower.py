...
img_width = 255
batch_size = 32
AUTOTUNE = tf.data.AUTOTUNE # 병렬연산 할 것인지에 대한 인자를 알아서 처리
...
def prepare(ds, shuffle=False, augment=False): 
    ...
    #Resize and recals all datasets.
...
# 추론, 학습에서 다르게 동작하는 layer들을 추론/학습 중 하나로만 동작하도록 함
...
model.save('transfer_leraning_flower.keras')
